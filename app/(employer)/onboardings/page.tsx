  ...
  return (
    <div>
      <div className="flex items-start justify-between mb-8 gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-fg tracking-tight">Onboardings</h1>
      ...
      {items.length === 0 ? (
        <div className="bg-ink-raised rounded-2xl border border-line shadow-sm px-8 py-16 flex flex-col items-center text-center max-w-md mx-auto">
          ...
          <h2 className="text-lg font-semibold text-fg mb-2">No onboardings yet</h2>
