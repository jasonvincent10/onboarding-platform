    ...
    <header className="bg-white border-b border-slate-200 sticky top-0 z-10">
      <div className="max-w-2xl mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <Link href="/employee/dashboard" className="flex items-center gap-2">
          ...
          <span className="text-xl font-extrabold tracking-tight text-violet-700 hidden sm:block">Vopria</span>
        </Link>
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="hidden sm:block text-xs font-medium text-violet-700 hover:text-violet-800 transition-colors"
          >
            My documents
          </Link>
          <Link
